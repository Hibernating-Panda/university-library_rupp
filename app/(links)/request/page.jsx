    ...
    <div className="min-h-screen w-full grid grid-cols-12 pr-5 absolute text-black">
      ...
      <div className="col-start-3 col-span-10 z-20 mt-20 pt-10 px-10 bg-[#F3F3F7]">
        <div className="w-full p-4">
          <h1 className="text-xl font-semibold mb-4 text-[#F76B56]">
            Borrow Requests
          </h1>
            ...
            return (
              ...
              >
                <Image
                  ...
                  height={200}
                  src={
                    req.book.coverImageUrl || `/api/books/${req.book.id}/cover`
                  }
                  alt={req.book.title}
                ...
                <p className={`font-semibold ${statusColor}`}>{req.status}</p>

                <p className="text-sm text-gray-500">
                  {new Date(req.reservedAt).toISOString().split("T")[0]}
                </p>
              </div>
            );
          })}
